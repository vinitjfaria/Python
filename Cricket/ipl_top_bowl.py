...
#url = input('Enter - ')
html = urlopen('http://stats.espncricinfo.com/ci/engine/records/averages/bowling.html?id=12210;type=tournament', context=ctx).read()
